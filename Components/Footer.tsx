        ...
        <footer className="footer p-10 bg-black text-base-content ">
          <div>
            ...
            <p>
              ...
              <br /> commodo erat acar accumsa lobortis, enim diam the nesuen.
            </p>
          </div>
          <div>
            ...
            <a href="/tour" className="link link-hover">
              Tour
            </a>
          ...
          <div>
            ...
            732/21 Second Street, <br /> Manchester, King Street, <br />{" "}
            Kingston United Kingdom
            <p>345-677-554</p>
            <p>info@altairtheme.com</p>
          </div>
        </footer>
